...
//         cy.visit('https://www.sohu.com')

//         // cy.get('div').should('have.id', 'main')
//         // cy.get('div').should('have.id', 'main')
//     })
// })

describe('质量平台', function () {
    it('Does not do much!', function () {
        cy.visit('https://fep.wemomo.com/personal/index')
        // const lis = cy.get('aside ul li')
        // lis.should('have.length', 7)
        // console.log(lis)
        // // debugger
        // for(let i =0; i<7; i++){
        //     lis.eq(i).click()
